...
function printTotalCalculations() {
    ...
    $values = ["addition" => $additionsInt, "subtraction" => $subtractionsInt, "multiply" => $multipliesInt,
        "division" => $divisionsInt,"root" => $rootInt, "square" => $squareInt, "x3" => $x3Int, "xn" => $xNInt, "sin" => $sin, "cos" => $cos, "tan" => $tan, "hexToDec" => $hexToDec, "decToHex" => $decToHex];
...
<body>
	...
	<br>Wenn du xN benutzt wird der zweite Wert als N gewertet.</p>
	
	<div>
		<h3>Durchgef&uuml;hrte Rechnungen (Anzahl)</h3>
		<p><?php printTotalCalculations(); ?></p>
	</div>
